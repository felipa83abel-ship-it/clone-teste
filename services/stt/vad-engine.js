...
const {
  ...
  class VADEngine {
    ...
    updateConfig(newOptions = {}) {
      if (newOptions.volumeThreshold !== undefined)
        this.volumeThreshold = newOptions.volumeThreshold;
      if (newOptions.energyThreshold !== undefined)
        this.energyThreshold = newOptions.energyThreshold;
