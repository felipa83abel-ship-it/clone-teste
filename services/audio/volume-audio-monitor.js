...
if (!globalThis._volumeAudioMonitorLoaded) {
  globalThis._volumeAudioMonitorLoaded = true;
  ...
  function handleVolumeMonitorUpdate(source, data) {
    ...
    if (eventBusGlobal && typeof eventBusGlobal.emit === 'function') {
      eventBusGlobal.emit(ev, { percent: data.percent });
    }
  }
  ...
  if (typeof globalThis !== 'undefined') {
    globalThis.startAudioVolumeMonitor = startAudioVolumeMonitor;
    globalThis.stopAudioVolumeMonitor = stopAudioVolumeMonitor;
    globalThis.switchAudioVolumeDevice = switchAudioVolumeDevice;
  }
