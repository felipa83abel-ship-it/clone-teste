...
- Screenshot capturado com sucesso (arquivo real)
...
- Mock validando fluxo completo de screenshot
- Análise GPT sendo simulada para teste

**Nota**: Em produção, a análise viria do GPT real com visão de imagens.
		`;
